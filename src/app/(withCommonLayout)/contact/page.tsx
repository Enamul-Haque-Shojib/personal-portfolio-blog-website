...
const ContactMe = () => {
  ...
  return (
    <div className="bg-gray-900 text-white py-16 flex flex-col min-h-screen" id="contact h-screen" >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          <div className="space-y-6">
            ...
            <div className="flex gap-5 text-2xl">
              <Link href="https://github.com/Enamul-Haque-Shojib" target="_blank" className="text-gray-300 hover:text-[#ff004f]">
                <i className="fa-brands fa-github" />
              </Link>
              <Link href="https://www.linkedin.com/in/enamul-haque-shojib-b1a738173/" target="_blank" className="text-gray-300 hover:text-[#ff004f]">
                    ...
                    <FormItem>
                      <FormControl>
                        <Input
                          ...
                          required
                          {...field}
                          className="w-full p-4 rounded-lg bg-gray-700 text-white border border-gray-600 focus:outline-none focus:ring-2 focus:ring-[#ff004f]"
                        />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
